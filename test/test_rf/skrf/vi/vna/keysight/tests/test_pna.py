...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('sweep_type', 'SENS1:SWE:TYPE?', 'SENS1:SWE:TYPE LIN',
         'LIN', SweepType.LINEAR, SweepType.LINEAR),
        ('sweep_mode', 'SENS1:SWE:MODE?', 'SENS1:SWE:MODE SING',
         'SING', SweepMode.SINGLE, SweepMode.SINGLE),
        ('measurement_numbers', 'SYST:MEAS:CAT? 1',
