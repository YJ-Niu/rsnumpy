...
class ConvenienceTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.hfss_threeport_file = os.path.join(
            self.test_dir, 'hfss_threeport_DB.s3p')
        self.hfss_threeport_file_50ohm = os.path.join(
            self.test_dir, 'hfss_threeport_DB_50Ohm.s3p')
    ...
    def test_is_hfss_touchstone(self):
        ...
        self.assertTrue(Touchstone(
            self.hfss_oneport_file).has_hfss_port_impedances)
        self.assertTrue(Touchstone(
            self.hfss_twoport_file).has_hfss_port_impedances)
        self.assertTrue(Touchstone(
            self.hfss_threeport_file).has_hfss_port_impedances)
        ...
        self.assertFalse(Touchstone(os.path.join(
            self.test_dir, 'ntwk1.s2p')).has_hfss_port_impedances)

    def test_hfss_touchstone_2_network(self):
        """
        Test the conversion into a Network of HFSS-generated touchstone files
        """
        nw_hfss_wo_z0 = rf.Network(os.path.join(
            self.test_dir, 'hfss_threeport_MA_without_gamma_z0_50Ohm.s3p'))
        nw_hfss_50 = rf.Network(os.path.join(
            self.test_dir, 'hfss_threeport_MA_50Ohm.s3p'))
        nw_hfss_z0 = rf.Network(os.path.join(
            self.test_dir, 'hfss_threeport_MA.s3p'))
    ...
    def test_cst_touchstone_2_network(self):
        ...
        """
        nw_cst_4ports = rf.Network(os.path.join(
            self.test_dir, 'cst_example_4ports.s4p'))
        nw_cst_6ports = rf.Network(os.path.join(
            self.test_dir, 'cst_example_6ports.s6p'))
    ...
    def test_cst_touchstone_V2_as_V1_2_network(self):
        ...
        """
        nw_cst_6ports = rf.Network(os.path.join(
            self.test_dir, 'cst_example_6ports_V2.s6p'))
    ...
    def test_cst_touchstone_V2_2_network(self):
        ...
        """
        nw_cst_6ports = rf.Network(os.path.join(
            self.test_dir, 'cst_example_6ports_V2.ts'))
    ...
    def test_helic_touchstone_V2_network(self):
        ntwk_helic_ts_extension = rf.Network(os.path.join(
            self.test_dir, 'helic_example_6ports_V2.ts'))
        ntwk_helic_sp_extension = rf.Network(os.path.join(
            self.test_dir, 'helic_example_6ports_V2.sp'))

        self.assertTrue((ntwk_helic_ts_extension.f ==
                        ntwk_helic_sp_extension.f).all())
        self.assertTrue((ntwk_helic_ts_extension.z0 ==
                        ntwk_helic_sp_extension.z0).all())
        self.assertTrue((ntwk_helic_ts_extension.s ==
                        ntwk_helic_sp_extension.s).all())
